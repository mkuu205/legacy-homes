...
import { User, Camera, Loader2, Eye, EyeOff, Shield, Home, Phone, Mail, Hash } from 'lucide-react';
...
export default function ProfilePage() {
  ...
  const changePasswordMutation = useMutation({
    mutationFn: async (data: typeof passwordData) => {
      await api.post('/residents/change-password', data);
    },
    onSuccess: () => {
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', maxWidth: '640px' }} className="fu">
      ...
      <div className="card">
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          ...
          <div style={{ position: 'relative' }}>
            <div
              style={{
                ...
                overflow: 'hidden',
                background: 'var(--gl)',
                border: '2px solid rgba(0, 198, 167, 0.25)',
                fontSize: '32px',
                fontWeight: 700,
                color: 'var(--ac)',
                fontFamily: 'var(--f1)',
          ...
          {/* Info */}
          <div style={{ flex: 1 }}>
            <h2 style={{ fontSize: '16px', fontWeight: 700, color: 'var(--t1)', marginBottom: '4px', fontFamily: 'var(--f1)' }}>
              {user?.fullName}
            </h2>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              <div className="badge b-ac" style={{ fontSize: '10px' }}>
                Resident
              </div>
              <div
                className="badge"
        ...
        >
          {[
            ...
            <div key={label} style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              ...
              <div>
                <p style={{ fontSize: '10px', color: 'var(--t3)', textTransform: 'uppercase', letterSpacing: '0.04em', fontWeight: 700 }}>
                  {label}
                </p>
                <p style={{ fontSize: '12px', fontWeight: 600, color: 'var(--t1)', marginTop: '2px' }}>
                  {value}
                </p>
              </div>
            </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
            ...
            <div className="fg">
              ...
              <input
                ...
                onChange={e => setProfileData(d => ({ ...d, houseNumber: e.target.value }))}
                className="inp"
              />
            </div>
