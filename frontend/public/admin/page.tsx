  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }} className="fu">
      ...
      <div style={{ marginBottom: '8px' }}>
        <h1 className="pg-h" style={{ fontSize: '32px' }}>Admin Dashboard</h1>
        <p className="pg-sh" style={{ fontSize: '13px' }}>
      ...
      <div className="g4" style={{ marginTop: '8px' }}>
        {kpis.map(({ label, value, sub, icon: Icon, color, href, trend }) => (
          ...
          >
            ...
            <div>
              <p className="stat-val" style={{ fontSize: '28px' }}>{value}</p>
              <p className="stat-lbl" style={{ fontSize: '11px', marginBottom: '6px' }}>{label}</p>
              <p style={{ fontSize: '11px', color: 'var(--t2)', marginTop: '2px' }}>{sub}</p>
            </div>
          </Link>
        ))}
      </div>
